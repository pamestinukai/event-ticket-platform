            ...
            <Container maxWidth='lg'>
                ...
                <Grid container spacing={3}>
                    <Grid size={9} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        ...
                        >
                            <Typography variant='h4' sx={{ pt: 4, pb: 2, fontWeight: 800 }}>
                                {event.title}
                            </Typography>
                            ...
                            <Stack spacing={1} sx={{ mb: 4 }}>
                                <EventDetail
                                    ...
                                    text={`${formatDate(event.startDatetime)} - ${formatTime(event.endDatetime)}`}
                                />
                                <EventDetail
                                    icon={<LocationOnIcon />}
                                    text={`${event.venue.name}, ${event.venue.city} · ${event.auditoriumName}`}
                                />
                        ...
                        <InfoCard title='Event location'>
                            ...
                            <EventDetail
                                icon={<LocationOnIcon />}
                                text={`${event.venue.address}, ${event.venue.city}, ${event.venue.country}`}
                            />
                        </InfoCard>
                        ...
                        <InfoCard title='Organizer'>
                            ...
                            >
                                ...
                                <Typography variant='body1' sx={{ fontWeight: 500 }}>
                                    {event.organization.companyName}
                                </Typography>
                            </Stack>
                            <Divider sx={{ mb: 2 }} />
                            <Stack spacing={1}>
                                <EventDetail
                                    icon={<EmailIcon />}
                                    text={event.organization.ownerEmail}
                                    href={`mailto:${event.organization.ownerEmail}`}
                                />
                                <EventDetail
                                    icon={<PhoneIcon />}
                                    text={event.organization.ownerPhone}
                                    href={`tel:${event.organization.ownerPhone}`}
                                />
                            </Stack>
                        </InfoCard>
                    </Grid>
                    ...
                    <Grid size={3}>
                        <Paper
                            elevation={4}
                            sx={{ mt: 2, padding: 3, borderRadius: { borderRadius }, position: 'sticky', top: 80 }}
                        >
